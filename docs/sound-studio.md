...
Final reward direction: restored the initial synthesized studio recipes for level-up and rare-item pickup at the user’s request. These two cues intentionally keep their soft ascending musical phrases; the recorded gong/bell and subsequent cloth/glass replacements are removed. Other audition cues retain their recorded foundations.
