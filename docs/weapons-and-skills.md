...
When an otherwise eligible basic attack or assigned skill fails its mana check, a blue glowing **Not Enough Mana** cue appears above the player for 1.15 seconds. It follows the player, gently rises and fades, and stays at native text size across camera zoom. Held or repeated attempts share one cue at a time; reduced motion removes the rise. Empty slots, incompatible gear and cooldowns do not trigger it. This feedback does not change costs, action timing or saves.
