...
The enlarged study, smaller comparison and frozen poses share the same renderer. Warden scale is reduced in the small comparison to fit its full axe; labels indicate the actual scale. One shared fixed PostFX pass keeps the game CRT treatment, with native DOM labels and bundled fonts. The operating system's reduced-motion preference starts the study paused at rest.
