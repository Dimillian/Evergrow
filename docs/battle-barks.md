...
- Roll once per humanoid when it first becomes aware of the player in an encounter: **25% chance**. Never roll per frame, attack, hit or alert propagation. Failed rolls are consumed. Successful rolls get **four seconds from engagement** to find a visible, safe placement; after that they expire.
