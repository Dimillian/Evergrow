...
Local loot log: the latest 100 successful pickups persist per character with original item details and current inventory/equipped/storage/ground/sold location. The inventory toolbar button, character drawer and pause menu open a shared paused reader. Existing saves retain progress and begin with empty history. See [Loot log](loot-log.md).
...
Local hairstyle refinement (2026-09-22): all 24 styles inspected in eight directions and on the full figure. Thirteen styles have clearer neck openings, softer loc/braid/ponytail shapes, rounded curl edges or consistent shaved temples. The appearance catalog adds a full-figure toggle. No appearance IDs or saves change. See [hairstyle refinement](character-editor.md#hairstyle-refinement--local-2026-09-22).

Local character anatomy pass (2026-09-22): one arm skeleton across equipment, shorter forearms, corrected upright grip depth, compact action targets, rounded elbow joins, smaller depth-sorted shoulder armor and a tapered plain tunic. The rig tool exposes all weapon profiles, focused directions, joint overlays, movement directions and action phases. Shared world/portrait presentation; no save reset. See [character appearance](character-editor.md#shared-anatomy-pass--local-2026-09-22).
...
| Town economy | Blacksmith equipment shop, jeweler jewelry stock, 12-item buyback, guaranteed +10 enhancement, rarity upgrades, single/all-affix rerolls and geographic relevel | Deterministic stock refresh at levels 4/7/10…; initial prices require player balance feedback |
