...
Battle-bark switch follow-up: `GAME_FEATURES.battleBarks` is an app-wide boolean, default true; false clears and suppresses all gameplay/review speech without a settings UI. The goblin now says “Your plan was to win?” in place of its former gutting threat. Verified 749 code tests, application/headless type checks and production build. Current source stats: 241 runtime modules / 26,390 lines, 97 code-test files, 24 review entrypoints, zero runtime dependencies.
