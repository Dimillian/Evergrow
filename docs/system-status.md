...
| Keyboard / mouse controls | Dedicated controls screen; saved primary/alternate bindings for movement, combat and shortcuts; explicit conflict replacement, unbind/reset; shared live HUD/atlas/interaction labels | Local device preference; controller layout remains fixed; see [controls](controls.md) |
