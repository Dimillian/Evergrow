...
| Skill atlas | Published 875-node, 932-edge six-territory map; 90 specialties, 30 skills, 90 Techniques, eight Doctrine families and four keystones; three ranks and finite old-tree point refund | Published in v0.3.16; further user combat/balance playtesting remains |
