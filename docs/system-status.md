...
| Enemy battle barks | Ashglass overhead bubbles; 20 lines each for seven humanoids, 25% engagement chance, four-second admission window, four-second lifetime, maximum three visible and shared spacing; no gameplay RNG or save state | Live encounter verified after reducing excessive suppression; [guide](battle-barks.md) |
