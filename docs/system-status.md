...
Local, 2026-09-13: six skill-changing Uniques, fixed level-scaled affixes, equal Unique/Legendary drop chances and a found/unfound Chronicles collection are implemented. Existing saves remain valid. Not published; see [Unique items](unique-items.md).
...
| Equipment | Twelve kinds, six rarities, eleven slots; 17 generated weapons, 3 shields and 6 caster foci; shared affixes with curated caster rolls; visible procedural gear | Recipe-based +10 enhancement and enchanting; six fixed Unique designs with skill powers |
