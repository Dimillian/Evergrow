...
Roaming encounters complement fixed camp garrisons. Their target is nine to fourteen living ambient enemies by area level, independently of camp membership, within the shared twenty-four-actor ceiling. At least nine actor slots remain reserved for roaming populations. Camp priority may sleep a farther wholly hidden garrison, but cannot remove visible actors or consume that reserve.
