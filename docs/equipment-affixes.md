...
One-handed swords, axes, maces and daggers can pair with a wand. Drag the wand into the offhand slot; ordinary automatic equip still targets the main hand. LMB uses the main weapon. Only two melee weapons alternate basic attacks. Magic skills select a compatible wand in either hand; melee skills similarly select their compatible hand, with main-hand preference. A two-handed weapon still reserves both hands. Fireball must be unlocked and assigned; an elemental sword alone does not satisfy its staff/wand requirement.
