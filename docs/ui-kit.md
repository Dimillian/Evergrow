...
The eleven equipment slots place Head above the doll, five armor slots to the left, and Main hand, Off hand, and jewelry to the right. Item details show handedness, attack family, range, and damage element; shields show both block chance and blocked-damage reduction. Eligible one-handed items offer an explicit Offhand action as well as drag/drop. Detailed stats include the second weapon's damage and cadence when dual wielding. Every hand change still goes through the inventory transaction rules.
