...
- **I:** opens Equipment & inventory: the equipped doll and eleven slots beside the 12×6 spatial pack and four dedicated charm rows. Item actions, appearance editing and quick skill assignment remain here. Footer links switch between the windows while paused.
