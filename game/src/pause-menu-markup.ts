    ...
    <div class="pause-layout">
      ...
      <div class="pause-detail">
        ...
        <section id="pause-options" aria-label="Options" hidden>
          ...
          ${audioControlsMarkup()}
          <div class="pause-option"><label for="ground-loot-names">Loot names</label><select id="ground-loot-names" data-loot-names class="ui-button" aria-label="Ground loot nameplates"><option value="always">Always</option><option value="ctrl">Hold Ctrl</option></select></div>
