...
export const TOOLS: readonly Tool[] = [
  ...
  {id:'event-choices',group:'world',name:'Event choices',path:'/events.html?choices',description:'Shared runtime action rows for every trial recipe, cargo and blessing choice, with objective and reward details, familiar icons and narrow previews.',tags:'interact dialogue quest level reward modal'},
  ...
  {id:'economy',group:'data',name:'Economy',path:'/progression.html?view=economy',description:'Estimate gold per session and level from enemy mixes, sales and activity rewards; compare enhancement costs and expected time to afford upgrades.',tags:'gold income economy progression balance enhancement cost simulation'},
