...
export const TOOLS: readonly Tool[] = [
  ...
  {id:'events',group:'world',name:'Events',path:'/events.html',description:'All world event progress previews, encounter recipes, objectives and reward presentation.',tags:'in progress timer waves seals defense chest animation'},
