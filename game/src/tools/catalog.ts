...
export const TOOLS: readonly Tool[] = [
  {id:'rifts',group:'world',name:'Crimson Rifts',path:'/tools/rifts.html',description:'Timed rift entry, animated tentacled portal, inventory keys, modifiers and personal records.'},
