...
export const TOOLS: readonly Tool[] = [
  ...
  {id:'console',group:'interface',name:'Command console',path:'/tools/console.html',description:'Centered local command-box proposal with contextual suggestions and keyboard completion over a frozen world.',tags:'cheat input autocomplete command palette'},
