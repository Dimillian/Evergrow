const ICONS = {
  ...
  skilltree: '<path d="m4 8 6-4 5 8 6-5M4 8l5 12 6-8" stroke-opacity=".55" stroke-width="1"/><path d="m15 8 1.1 2.9L19 12l-2.9 1.1L15 16l-1.1-2.9L11 12l2.9-1.1ZM9 17l.8 2.2L12 20l-2.2.8L9 23l-.8-2.2L6 20l2.2-.8Z" fill="currentColor" stroke="none"/><circle cx="4" cy="8" r="1.6" fill="currentColor" stroke="none"/><circle cx="10" cy="4" r="1.6" fill="currentColor" stroke="none"/><circle cx="21" cy="7" r="1.6" fill="currentColor" stroke="none"/>',
