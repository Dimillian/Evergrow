...
export const PERFORMANCE_GRAPHS: readonly PerformanceGraph[] = [
  ...
  { id: 'cpu', label: 'CPU breakdown', unit: 'ms', note: 'Top-level CPU stages. Other includes input, events and unassigned work.', series: [series('simulation', 'Simulation', '#8ddbc3'), series('world', 'World', '#dfc58b'), series('postfx', 'Post FX', '#b3a4e8'), series('ui', 'UI', '#85bfe8'), series('panels', 'NPC / inventory', '#f5a86e'), series('other', 'Other', '#e39a91'), series('monitor', 'Monitor', '#afb8bf')] },
