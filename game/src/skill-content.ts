...
export const SKILL_DEFINITIONS: Readonly<Record<SkillId, Readonly<SkillDefinition>>> = Object.freeze({
  ...
  nightReaping: Object.freeze({ id: 'nightReaping', name: 'Night Reaping', description: 'Your dagger strikes up to five nearby enemies in every direction. Rear strikes deal double damage. Does not teleport or grant invulnerability.', requirement: 'dagger', domain: 'Cunning', tier: 'ultimate', manaCost: 36, cooldown: 28, damageMultiplier: 2.2, color: '#b9e3d6' }),
  sidestep: Object.freeze({ id: 'sidestep', name: 'Sidestep', description: 'Step toward your aim without invulnerability. Terrain still blocks movement.', requirement: 'any', domain: 'Cunning', tier: 'advanced', manaCost: 6, cooldown: 3.5, damageMultiplier: 0, color: '#b5cbb8' }),
  brace: Object.freeze({ id: 'brace', name: 'Brace', description: 'Brace for 2 seconds, taking 20% less hit damage. Does not require a shield.', requirement: 'any', domain: 'Might', tier: 'advanced', manaCost: 11, cooldown: 8, damageMultiplier: 0, color: '#cfb88f' }),
  runicWard: Object.freeze({ id: 'runicWard', name: 'Runic Ward', description: 'Create a barrier equal to 18% of maximum life for 4 seconds. Absorbs damage after mitigation; does not stack.', requirement: 'magic', domain: 'Arcana', tier: 'advanced', manaCost: 17, cooldown: 10, damageMultiplier: 0, color: '#9ed6d5' }),
  vaultingShot: Object.freeze({ id: 'vaultingShot', name: 'Vaulting Shot', description: 'Loose one arrow toward your aim while retreating. The retreat has no invulnerability.', requirement: 'bow', domain: 'Cunning', tier: 'advanced', manaCost: 17, cooldown: 6, damageMultiplier: 1.2, color: '#a7c897' }),
  rallyOfIron: Object.freeze({ id: 'rallyOfIron', name: 'Rally of Iron', description: 'For 6 seconds take 25% less hit damage. The next three melee actions deal 35% more damage.', requirement: 'melee', domain: 'Might', tier: 'ultimate', manaCost: 32, cooldown: 24, damageMultiplier: 0, color: '#d4a677' }),
  ghostHunt: Object.freeze({ id: 'ghostHunt', name: 'Ghost Hunt', description: 'For 6 seconds, your next three projectile arrow actions each release one delayed echo along the original aim. Echoes deal 60% of the first arrow’s damage and retain its critical chance, piercing and rebounds. They cannot restore life, apply statuses or create more echoes.', requirement: 'bow', domain: 'Cunning', tier: 'ultimate', manaCost: 30, cooldown: 24, damageMultiplier: 0, color: '#c5dbc7' }),
  ...
  cleave: Object.freeze({ id: 'cleave', name: 'Crescent Cleave', description: 'Sweep a melee weapon through a broad crescent, striking each nearby enemy once.', requirement: 'melee', domain: 'Might', tier: 'basic', manaCost: 9, cooldown: 0, damageMultiplier: 1.8, color: '#e6bd7b' }),
  lunge: Object.freeze({ id: 'lunge', name: 'Rift Lunge', description: 'Drive your blade forward in a swift dash, cutting enemies along your path.', requirement: 'blade', domain: 'Might', tier: 'advanced', manaCost: 18, cooldown: 4, damageMultiplier: 1.5, color: '#add9ca' }),
  whirlwind: Object.freeze({ id: 'whirlwind', name: 'Whirlwind', description: 'Turn a full circle with your melee weapon, sweeping through enemies on every side.', requirement: 'melee', domain: 'Might', tier: 'basic', manaCost: 9, cooldown: 0, damageMultiplier: 1.6, color: '#d8c28c' }),
  earthshatter: Object.freeze({ id: 'earthshatter', name: 'Earthshatter', description: 'Slam an axe or mace into the ground. The shockwave damages and stuns nearby enemies.', requirement: 'heavy', domain: 'Might', tier: 'advanced', manaCost: 27, cooldown: 6, damageMultiplier: 2.6, color: '#d9a077' }),
  shieldBash: Object.freeze({ id: 'shieldBash', name: 'Shield Bash', description: 'Batter enemies in front of you with your shield, damaging and stunning them.', requirement: 'shield', domain: 'Might', tier: 'basic', manaCost: 8, cooldown: 0, damageMultiplier: 1.35, color: '#b7c9bf' }),
  bulwark: Object.freeze({ id: 'bulwark', name: 'Bulwark', description: `Raise your shield in a lasting guard, greatly reducing incoming damage for ${SKILL_EXECUTION.bulwark.duration} seconds.`, requirement: 'shield', domain: 'Might', tier: 'advanced', manaCost: 24, cooldown: 8, damageMultiplier: 0, color: '#b8ccdb' }),
  volley: Object.freeze({ id: 'volley', name: 'Thorn Volley', description: `Loose ${SKILL_EXECUTION.volley.offsets.length} arrows from your bow in a spreading fan. Each arrow stops at its first enemy.`, requirement: 'bow', domain: 'Cunning', tier: 'basic', manaCost: 8, cooldown: 0, damageMultiplier: .8, color: '#a6ce9d' }),
  piercingShot: Object.freeze({ id: 'piercingShot', name: 'Piercing Shot', description: `Draw a powerful bow shot that pierces through up to ${SKILL_EXECUTION.piercingShot.effects.pierce + 1} enemies in a line.`, requirement: 'bow', domain: 'Cunning', tier: 'advanced', manaCost: 21, cooldown: 3.5, damageMultiplier: 1.6, color: '#d0d7a1' }),
  ricochet: Object.freeze({ id: 'ricochet', name: 'Ricochet', description: `Fire an arrow that rebounds between nearby enemies, striking up to ${SKILL_EXECUTION.ricochet.effects.chain + 1} different targets.`, requirement: 'bow', domain: 'Cunning', tier: 'basic', manaCost: 9, cooldown: 0, damageMultiplier: 1.2, color: '#c0dca6' }),
  rainOfArrows: Object.freeze({ id: 'rainOfArrows', name: 'Rain of Arrows', description: `Mark an area with your bow. ${groundEffectPulseCount(SKILL_EXECUTION.rainOfArrows)} waves of falling arrows strike it after a short delay.`, requirement: 'bow', domain: 'Cunning', tier: 'advanced', manaCost: 27, cooldown: 6, damageMultiplier: .7, color: '#b7c49a' }),
  backstab: Object.freeze({ id: 'backstab', name: 'Backstab', description: `Make a close dagger thrust. Striking an enemy from behind deals ${SKILL_EXECUTION.backstab.rearMultiplier}× damage.`, requirement: 'dagger', domain: 'Cunning', tier: 'basic', manaCost: 8, cooldown: 0, damageMultiplier: 2.1, color: '#d1b2c3' }),
