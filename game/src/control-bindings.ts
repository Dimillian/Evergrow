...
export const CONTROL_ACTIONS = [
  ...
  { id: 'portal', label: 'Town portal', group: 'World & menus', defaults: ['KeyR', null], pad: 'D-pad ↓' },
  { id: 'character', label: 'Character stats', group: 'World & menus', defaults: ['KeyP', null], pad: 'D-pad ←' },
  { id: 'inventory', label: 'Equipment / inventory', group: 'World & menus', defaults: ['KeyI', null], pad: 'D-pad →' },
