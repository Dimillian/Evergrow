...
export function appearanceHeadShapes(appearance: Readonly<CharacterAppearance>, facing: number, covered: boolean): GearShape[] {
  ...
  if (!back) {
    // Skin covers the whole cranium; the smaller face alone leaves a false hairline.
    shape([[-3.65, -.7], [-2.8, -3.45], [.5, -4.2], [3.2, -2.4], [3.65, .6], [2.3, 3.7], [.7, 4.7], [-1.7, 4.1], [-3.35, 1.6]], skin.base);
    shape([[-3.65, -.7], [-2.8, -3.45], [-1.4, -3.8], [-2, -.6], [-1.7, 4.1], [-3.35, 1.6]], skin.shadow);
