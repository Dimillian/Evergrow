...
- `game/src/skill-tree.ts`: immutable graph of 2,779 stars across Might, Cunning, and Arcana; stable IDs, validated connected allocation, bonus aggregation, and skill unlock lookup. Six first-ring majors unlock active skills; minors/notables reuse authored stat families.
